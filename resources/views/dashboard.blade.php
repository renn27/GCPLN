...
<body class="bg-slate-50/50 text-slate-700 font-sans antialiased">
    ...
    <div class="min-h-screen flex flex-col" x-data="{
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <div class="ml-2">
                            <p class="text-sm md:text-base font-bold text-blue-600 leading-tight">GC DTSEN - PLN OGAN
                                ILIR</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center">
                        <span
                            class="text-xs text-slate-400 hidden md:block px-3 py-1.5 bg-slate-50 rounded-full border border-slate-200">
        ...
        <main class="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
                ...
                <div class="flex flex-wrap gap-2.5">
                    ...
                    <div class="relative" @mouseenter="clearTimeout(dropdownTimeout); dropdownOpen = true"
                        @mouseleave="dropdownTimeout = setTimeout(() => dropdownOpen = false, 200)">
                        <button
                            class="group px-4 py-2.5 bg-white border border-slate-200 text-slate-700 rounded-xl shadow-sm text-sm font-medium hover:bg-slate-50 hover:border-slate-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 flex items-center gap-2">
            ...
            @if (session('success'))
                <div
                    class="mb-8 bg-emerald-50 border border-emerald-200 p-4 rounded-xl shadow-sm flex items-start gap-3 animate-in fade-in slide-in-from-top-2 duration-300">
                    <div
                        class="flex-shrink-0 w-5 h-5 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-600">
            ...
            @if ($errors->any())
                <div class="mb-8 bg-rose-50 border border-rose-200 p-4 rounded-xl shadow-sm">
                    <div class="flex items-start gap-3">
                        <div
                            class="flex-shrink-0 w-5 h-5 rounded-full bg-rose-100 flex items-center justify-center text-rose-600">
                            <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-200/80 p-5 hover-lift group">
                    <div class="flex items-start justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-slate-800 tracking-tight">{{ number_format($totalOpen) }}
                            </p>
                        </div>
                        <div
                            class="w-10 h-10 rounded-xl bg-slate-100 flex items-center justify-center text-slate-500 group-hover:bg-slate-200 transition-colors">
                    ...
                    <div class="flex items-start justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-blue-600 tracking-tight">
                                {{ number_format($totalSubmitted) }}</p>
                        </div>
                        <div
                            class="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center text-blue-600 group-hover:bg-blue-100 transition-colors">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M5 13l4 4L19 7" />
                            </svg>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-slate-200/80 p-5 hover-lift group">
                    <div class="flex items-start justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-rose-500 tracking-tight">
                                {{ number_format($totalRejected) }}</p>
                        </div>
                        <div
                            class="w-10 h-10 rounded-xl bg-rose-50 flex items-center justify-center text-rose-500 group-hover:bg-rose-100 transition-colors">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M6 18L18 6M6 6l12 12" />
                            </svg>
                ...
                <!-- Persentase GC -->
                <div
                    class="bg-gradient-to-br from-emerald-50 to-white rounded-2xl shadow-sm border border-emerald-200/80 p-5 hover-lift group">
                    <div class="flex items-start justify-between">
                        <div>
                            <p class="text-xs font-semibold text-emerald-600/70 uppercase tracking-wider mb-1">
                                Persentase</p>
                            <p class="text-3xl font-bold text-emerald-700 tracking-tight">{{ $totalPersentase }}%</p>
                        </div>
                        <div
                            class="w-10 h-10 rounded-xl bg-emerald-100 flex items-center justify-center text-emerald-700 group-hover:bg-emerald-200 transition-colors">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="mb-8">
                <div class="flex items-center gap-2 mb-4">
                    ...
                    <span class="ml-auto text-xs text-slate-400 bg-slate-100 px-2 py-1 rounded-full">Detail
                        Status</span>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-slate-200/80 p-5 hover-lift group">
                        <div class="flex items-start justify-between">
                            <div>
                                <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1">Berhasil
                                </p>
                                <p class="text-3xl font-bold text-emerald-600 tracking-tight">
                                    {{ number_format($totalBerhasilDidata) }}</p>
                            </div>
                            <div
                                class="w-10 h-10 rounded-xl bg-emerald-50 flex items-center justify-center text-emerald-600 group-hover:bg-emerald-100 transition-colors">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-slate-200/80 p-5 hover-lift group">
                        <div class="flex items-start justify-between">
                            <div>
                                <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1">Kosong
                                </p>
                                <p class="text-3xl font-bold text-amber-500 tracking-tight">
                                    {{ number_format($totalTidakAdaResponden) }}</p>
                            </div>
                            <div
                                class="w-10 h-10 rounded-xl bg-amber-50 flex items-center justify-center text-amber-600 group-hover:bg-amber-100 transition-colors">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-slate-200/80 p-5 hover-lift group">
                        <div class="flex items-start justify-between">
                            <div>
                                <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1">Menolak
                                </p>
                                <p class="text-3xl font-bold text-rose-500 tracking-tight">
                                    {{ number_format($totalRespondenMenolak) }}</p>
                            </div>
                            <div
                                class="w-10 h-10 rounded-xl bg-rose-50 flex items-center justify-center text-rose-500 group-hover:bg-rose-100 transition-colors">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-slate-200/80 p-5 hover-lift group">
                        <div class="flex items-start justify-between">
                            <div>
                                <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1">No Meter
                                </p>
                                <p class="text-3xl font-bold text-orange-500 tracking-tight">
                                    {{ number_format($totalMeteranTidakDitemukan) }}</p>
                            </div>
                            <div
                                class="w-10 h-10 rounded-xl bg-orange-50 flex items-center justify-center text-orange-500 group-hover:bg-orange-100 transition-colors">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <!-- Persentase Berhasil -->
                    <div
                        class="bg-gradient-to-br from-purple-50 to-white rounded-2xl shadow-sm border border-purple-200/80 p-5 hover-lift group">
                        <div class="flex items-start justify-between">
                            <div>
                                <p class="text-xs font-semibold text-purple-600/70 uppercase tracking-wider mb-1">%
                                    Berhasil</p>
                                <p class="text-3xl font-bold text-purple-700 tracking-tight">
                                    {{ $persentaseBerhasil }}%</p>
                            </div>
                            <div
                                class="w-10 h-10 rounded-xl bg-purple-100 flex items-center justify-center text-purple-700 group-hover:bg-purple-200 transition-colors">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                                </svg>
                        ...
                        <div class="mt-2 w-full bg-purple-100 rounded-full h-1.5">
                            <div class="bg-purple-500 h-1.5 rounded-full transition-all duration-500"
                                style="width: {{ min($persentaseBerhasil, 100) }}%"></div>
                        </div>
        ...
        <div x-show="showImportPetugas" class="fixed z-50 inset-0 overflow-y-auto" style="display: none;"
            x-transition.opacity.duration.200ms>
            <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                <div x-show="showImportPetugas" x-transition.opacity
                    class="fixed inset-0 bg-slate-900/40 backdrop-blur-sm transition-opacity" aria-hidden="true"
                    @click="showImportPetugas = false"></div>
                <span class="hidden sm:inline-block sm:align-middle sm:h-screen" aria-hidden="true">&#8203;</span>
                <div x-show="showImportPetugas" x-transition.scale.origin.top.duration.200ms
                    ...
                    <form action="{{ route('import.petugas') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input type="password" name="password" required
                                        class="block w-full border border-slate-200 rounded-xl p-2.5 text-sm text-slate-800 bg-slate-50/50 focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        <input type="file" name="file_petugas" required
                                            class="block w-full text-sm text-slate-500 file:mr-4 file:py-2.5 file:px-5 file:rounded-xl file:border-0 file:text-xs file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 border border-slate-200 rounded-xl p-1.5 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500">
                                    </div>
                        ...
                        <div
                            class="bg-slate-50/80 px-5 py-4 sm:px-6 flex flex-row-reverse gap-2 border-t border-slate-200">
                            <button type="submit"
                                class="px-5 py-2.5 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-xl text-sm font-medium hover:from-blue-700 hover:to-blue-600 shadow-md shadow-blue-200 transition-all flex items-center gap-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" />
                                </svg>
                            ...
                            <button type="button" @click="showImportPetugas = false"
                                class="px-5 py-2.5 bg-white border border-slate-200 text-slate-600 rounded-xl text-sm font-medium hover:bg-slate-50 transition-colors">
                                Batal
                            </button>
                        </div>
                    </form>
        ...
        <!-- Modal Import GC -->
        <div x-show="showImportGc" class="fixed z-50 inset-0 overflow-y-auto" style="display: none;"
            x-transition.opacity.duration.200ms>
            <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                <div x-show="showImportGc" x-transition.opacity
                    class="fixed inset-0 bg-slate-900/40 backdrop-blur-sm transition-opacity" aria-hidden="true"
                    @click="showImportGc = false"></div>
                <span class="hidden sm:inline-block sm:align-middle sm:h-screen" aria-hidden="true">&#8203;</span>
                <div x-show="showImportGc" x-transition.scale.origin.top.duration.200ms
                    class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-md sm:w-full border border-slate-100">
                    <form action="{{ route('import.gc') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label class="block text-xs font-semibold text-slate-600 mb-1.5">PASSWORD
                                        IMPORT</label>
                                    <input type="password" name="password" required
                                        class="block w-full border border-slate-200 rounded-xl p-2.5 text-sm text-slate-800 bg-slate-50/50 focus:bg-white focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 transition-all"
                                        placeholder="Masukkan password...">
                                </div>

                                <div>
                                    <label class="block text-xs font-semibold text-slate-600 mb-1.5">FILE EXCEL
                                        GC</label>
                                    <div class="relative">
                                        <input type="file" name="file_gc" required
                        ...
                        <div
                            class="bg-slate-50/80 px-5 py-4 sm:px-6 flex flex-row-reverse gap-2 border-t border-slate-200">
                            <button type="submit"
                                class="px-5 py-2.5 bg-gradient-to-r from-amber-600 to-amber-500 text-white rounded-xl text-sm font-medium hover:from-amber-700 hover:to-amber-600 shadow-md shadow-amber-200 transition-all flex items-center gap-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" />
                                </svg>
                            ...
                            <button type="button" @click="showImportGc = false"
                                class="px-5 py-2.5 bg-white border border-slate-200 text-slate-600 rounded-xl text-sm font-medium hover:bg-slate-50 transition-colors">
                                Batal
                            </button>
                        </div>
        ...
        <div x-show="showImportKeterangan" class="fixed z-50 inset-0 overflow-y-auto" style="display: none;"
            x-transition.opacity.duration.200ms>
            <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                <div x-show="showImportKeterangan" x-transition.opacity
                    class="fixed inset-0 bg-slate-900/40 backdrop-blur-sm transition-opacity" aria-hidden="true"
                    @click="showImportKeterangan = false"></div>
                <span class="hidden sm:inline-block sm:align-middle sm:h-screen" aria-hidden="true">&#8203;</span>
                <div x-show="showImportKeterangan" x-transition.scale.origin.top.duration.200ms
                    class="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-md sm:w-full border border-slate-100">
                    <form action="{{ route('import.keterangan') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    <label class="block text-xs font-semibold text-slate-600 mb-1.5">PASSWORD
                                        IMPORT</label>
                                    <input type="password" name="password" required
                                        class="block w-full border border-slate-200 rounded-xl p-2.5 text-sm text-slate-800 bg-slate-50/50 focus:bg-white focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 transition-all"
                                        placeholder="Masukkan password...">
                                </div>
                                ...
                                <div>
                                    <label class="block text-xs font-semibold text-slate-600 mb-1.5">FILE EXCEL
                                        KETERANGAN</label>
                                    <div class="relative">
                                        <input type="file" name="file_keterangan" required
                                    ...
                                    <p class="text-[10px] text-slate-400 mt-1.5 flex items-center gap-1">
                                        ...
                                        Kolom: UNITUPI, UNITAP, UNITUP, 1. Berhasil didata, 2. Tidak ada responden...,
                                        3. Responden menolak, 4. Meteran tidak ditemukan
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div
                            class="bg-slate-50/80 px-5 py-4 sm:px-6 flex flex-row-reverse gap-2 border-t border-slate-200">
                            <button type="submit"
                                class="px-5 py-2.5 bg-gradient-to-r from-purple-600 to-purple-500 text-white rounded-xl text-sm font-medium hover:from-purple-700 hover:to-purple-600 shadow-md shadow-purple-200 transition-all flex items-center gap-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" />
                                </svg>
                            ...
                            <button type="button" @click="showImportKeterangan = false"
                                class="px-5 py-2.5 bg-white border border-slate-200 text-slate-600 rounded-xl text-sm font-medium hover:bg-slate-50 transition-colors">
                                Batal
                            </button>
                        </div>
            ...
            if (table) {
                ...
                table.querySelectorAll('th.sort-header').forEach(th => {
                    th.addEventListener('click', function() {
                        ...
                        setTimeout(() => {
                            const isDescending = this.getAttribute('aria-sort') ===
                                'descending';
                            if (isDescending) {
